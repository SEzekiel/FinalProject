    ...
    <nav class="uk-navbar-container" uk-navbar style="position: relative; z-index: 980;">
        <div class="uk-navbar-left">
            <ul class="uk-navbar-nav">
                <li class="uk-active">&nbsp;&nbsp;New contact</li>
            </ul>
        ...
        <div class="uk-navbar-right">
            <ul class="uk-navbar-nav">
              <li class="uk-active"><a href="." style="font-size: 25px; font-weight: bold">&#10008;</a></li>
                <li class="uk-active"><a href="editContact.php" style="font-size: 25px; font-weight: bold">&#10004;</a></li>
            </ul>
...
<form>
    ...
    <button class="uk-button uk-button-default" type="button" tabindex="-1">Select an image</button>
</div>
</form>
